...
`;
      ...
      onStoryboardsGenerated(generatedStoryboards);
              ...
              >
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-800 bg-blue-50 p-2 rounded border">
                      {storyboard.characterAction}
                    </p>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-800 bg-yellow-50 p-2 rounded border">
                        {storyboard.mood}
                      </p>
                    </div>
                  </div>
